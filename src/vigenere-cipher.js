class VigenereCipheringMachine {
    ...
    encrypt(string, key) {
        ...
        return this.modification ? encrstring.join('').toUpperCase() : encrstring.reverse().join('').toUpperCase();
    ...
    decrypt(encrstring, key) {
        ...
        return this.modification ? decryptedstring.join('').toUpperCase() : decryptedstring.reverse().join('').toUpperCase();
